...
![The brave Hackathon team for Simon's kata](https://martinquantum.github.io/_posts/pictures/"2018 Hackathon Team with Dan Simon.jpg")
...
The new wrinkle to this story is something we learned from Dan: he told us that he and Peter actually made a pact: in 1994 the market for quantum computing papers was super-thin and not many (if any!) papers were expected to be accepted to a high-profile conference such as FOCS. So the deal was that if one of the two papers gets in and the other one gets rejected, then they would have merged the papers anyways and published it as a two-author paper (!) History had it that both papers got in...  
